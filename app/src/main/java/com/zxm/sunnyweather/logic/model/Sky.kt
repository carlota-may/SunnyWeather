...
private val sky = mapOf(
        ...
        "PARTLY_COULD_DAY" to Sky("多云", R.mipmap.ic_partly_cloud_day, R.mipmap.bg_partly_cloudy_day),
        "PARTLY_COULD_NIGHT" to Sky("多云", R.mipmap.ic_partly_cloud_night, R.mipmap.bg_partly_cloudy_night),
        "COULD" to Sky("阴", R.mipmap.ic_cloudy, R.mipmap.bg_cloudy),
        ...
        "SHEET" to Sky("雨夹雪", R.mipmap.ic_sleet, R.mipmap.bg_rain),
        "LIGHT_SHOW" to Sky("小雪", R.mipmap.ic_light_snow, R.mipmap.bg_snow),
        "MODERATE_SHOW" to Sky("中雪", R.mipmap.ic_moderate_snow, R.mipmap.bg_snow),
        "HEAVY_SHOW" to Sky("大雪", R.mipmap.ic_heavy_snow, R.mipmap.bg_snow),
        "STORM_SHOW" to Sky("暴雪", R.mipmap.ic_heavy_snow, R.mipmap.bg_snow),
        "HAIL" to Sky("冰雹", R.mipmap.ic_hail, R.mipmap.bg_snow),
        "LIGHT_HAZE" to Sky("轻度雾霾", R.mipmap.ic_light_haze, R.mipmap.bg_fog),
        "MODERATE_HAZE" to Sky("重度雾霾", R.mipmap.ic_moderate_haze, R.mipmap.bg_fog),
